...
if( !class_exists( "BB_Ultimate_Addon" ) ) {
	...
	define( 'BB_ULTIMATE_ADDON_LITE_VERSION', '1.2.4' );
	...
	class BB_Ultimate_Addon {
		...
		*/
		function __construct() {
			...
			require_once 'includes/lib/notices/class-astra-notices.php';
		}
...
if ( ! function_exists( 'register_notices' ) ) :
	...
	*/
	function register_notices() {
		$image_path = BB_ULTIMATE_ADDON_URL.'assets/images/icon.svg';
			...
			array(
				...
				'message'                    => sprintf(
					'<div class="notice-image">
						<img src="%1$s" class="custom-logo" alt="uabb" itemprop="logo"></div> 
					...
					$image_path,
					__( 'Hello! Seems like you have used Astra Hooks to build this website — Thanks a ton!', 'uabb' ),
					__( 'Could you please do us a BIG favor and give it a 5-star rating on WordPress? This would boost our motivation and help other users make a comfortable decision while choosing the Astra Hooks.', 'uabb' ),
					'https://wordpress.org/support/plugin/ultimate-addons-for-beaver-builder-lite/reviews/?filter=5#new-post',
